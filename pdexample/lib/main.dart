...
class MySecondApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(onGenerateRoute: generateRoute, initialRoute: 'presentation');
  }
}
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return SizedBox(height: 50, child: Center(child: Text(' ${displays[index]?.displayId} ${displays[index]?.name}')));
          },
        ),
        const Divider(),
      ],
      ...
      children: [
        Padding(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Index to share screen'),
          ),
        ),
        Button(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: TextField(
            controller: _indexToShareController,
            decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Index to hide screen'),
          ),
        ),
        Button(
      ...
      children: [
        Padding(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Data to transfer'),
          ),
        ),
        Button(
          title: "TransferData",
      ...
      children: [
        Padding(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(border: OutlineInputBorder(), labelText: 'Index'),
          ),
        ),
        Button(
          title: "NameByIndex",
